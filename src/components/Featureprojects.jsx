  ...
  const projects = [
    {
      ...
      description:
        "Premium residential towers with panoramic city views and luxury amenities.",
    },
    {
      id: 2,
      ...
      description:
        "Eco-friendly residences surrounded by greenery and modern facilities.",
    },
    {
      id: 3,
      ...
      description:
        "Luxury apartments with stunning lake views and premium finishes.",
    },
    {
      id: 4,
      ...
      status: "Available",
      image:
        "https://images.unsplash.com/photo-1598928506311-bf1256de7b3b?q=80&w=2070&auto=format&fit=crop",
      specs: [
        "Clear Title",
        "Approved Layout",
        "Road Access",
      ...
      description:
        "Premium plots in developing IT corridor with excellent appreciation potential.",
    },
    {
      id: 5,
      name: "Royal Gardens",
      ...
      description:
        "Ultra-luxury villas with private gardens and exclusive amenities.",
    },
    {
      id: 6,
      name: "Urban Lofts",
      ...
      description:
        "Contemporary lofts with industrial design elements in heart of the city.",
    },
  ];
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-lg text-gray-600">
            Discover premium properties with exceptional value and lifestyle
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {marketPrices.map((item, index) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-pink-600 my-2">
                  {item.price}
                </div>
                <div
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6">
              Our team will contact you with detailed information
            </p>
      ...
      {showSiteVisitForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6">
              Book your visit to {selectedProject?.name}
            </p>
