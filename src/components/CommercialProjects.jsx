...
function CommercialProjects() {
  ...
  const featuredProjects = [
    {
      ...
      highlights: ["LEED Platinum Certified", "24/7 Power Backup", "Smart Building", "Ample Parking"],
      description: "Premium Grade A office spaces designed for corporates and IT companies with world-class amenities and connectivity.",
      amenities: ["High-Speed Elevators", "Food Court", "Fitness Center", "Conference Rooms", "Banking", "Security"],
    ...
    },
    {
      ...
      highlights: ["Metro Connectivity", "Anchor Tenants", "Parking for 500+ cars", "Food Court"],
      description: "Modern retail destination with premium brands, entertainment zones, and dining options in prime location.",
      amenities: ["Central AC", "Escalators", "Parking", "Security", "Maintenance", "Promotional Support"],
      possession: "Dec 2024"
    }
  ];
  ...
  const commercialProjects = [
    {
      ...
      highlights: ["Dedicated IT Infrastructure", "Fiber Optic Connectivity", "Conference Facilities"]
    },
    {
      id: 4,
    ...
    },
    {
      ...
      highlights: ["Panoramic City Views", "Premium Finishes", "Executive Lounges"]
    },
    {
      id: 7,
  ...
  const services = [
    {
      icon: "🏢",
      title: "Office Spaces",
      description: "Grade A office buildings with modern amenities and prime locations"
    },
    {
      icon: "🛍️",
      title: "Retail Spaces",
      description: "Shopping malls, high street retail, and commercial complexes"
    },
    {
      icon: "🏭",
  ...
  const filteredProjects = activeCategory === 'all' 
    ? commercialProjects 
    : commercialProjects.filter(project => project.category === activeCategory);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Commercial Projects</h1>
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
            Premium commercial spaces designed for business success. Offices, retail, industrial, and mixed-use developments.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {featuredProjects.map((project) => (
              <div key={project.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                      project.status === "Ready to Occupy" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
                    }`}>
                      {project.status}
                    </span>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 font-semibold"
                  >
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover our diverse portfolio of commercial properties across different categories and locations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              <div key={project.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div>
                      ...
                      <div className="font-semibold text-gray-900 text-sm">{project.size}</div>
                    </div>
                    <div>
                      <div className="text-xs text-gray-600">Price</div>
                      <div className="font-semibold text-gray-900 text-sm">{project.price}</div>
                    </div>
                  </div>
                  ...
                  <button 
                    onClick={() => handleViewDetails(project)}
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 rounded-lg hover:shadow-lg transition-all duration-300 font-semibold text-sm"
                  >
                    View Details
                  </button>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let us help you find the perfect commercial space for your business growth and success.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Premium commercial real estate solutions for businesses of all sizes.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Office Spaces</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Retail Properties</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Industrial Parks</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Mixed Use</a></li>
              </ul>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                  selectedProject.status === "Ready to Occupy" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
                }`}>
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedProject.possession && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{selectedProject.possession}</span>
                      </div>
                    )}
                  </div>
                </div>
