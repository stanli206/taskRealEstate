  ...
  const featuredPosts = [
    {
      ...
      excerpt:
        "Analysis of upcoming trends, price movements, and investment opportunities in the Indian real estate market.",
      category: "market",
      readTime: "8 min read",
      date: "Nov 8, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Everything you need to know about RERA regulations and how they safeguard your real estate investments.",
      category: "legal",
      readTime: "6 min read",
      date: "Nov 5, 2024",
      image:
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "From location to budget, here are the key factors that every first-time home buyer should evaluate.",
      category: "home",
      readTime: "5 min read",
      date: "Nov 3, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive comparison to help you choose between luxury apartments and independent villas.",
      category: "luxury",
      readTime: "7 min read",
      date: "Oct 30, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Expert strategies to maximize your returns in the competitive real estate market.",
      category: "investment",
    ...
    },
    {
      ...
      excerpt:
        "Navigate the complexities of home loans with our comprehensive guide to interest rates and eligibility.",
      category: "home",
      readTime: "9 min read",
      date: "Oct 25, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "How smart home technology is transforming the way we live and what to look for in a smart home.",
      category: "luxury",
      readTime: "6 min read",
      date: "Oct 22, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "A detailed walkthrough of the property registration process and important documents required.",
      category: "legal",
      readTime: "8 min read",
      date: "Oct 18, 2024",
      image:
  ...
  const popularPosts = [
    {
      ...
      excerpt:
        "Discover the fastest-growing real estate markets that offer great investment potential.",
      category: "investment",
      readTime: "5 min read",
      date: "Oct 15, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Learn about green building certifications and how they contribute to sustainable living.",
      category: "luxury",
      readTime: "7 min read",
      date: "Oct 12, 2024",
      image:
      ...
      <section className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto">
            Expert insights, market trends, and valuable tips for your real
            estate journey
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-900 to-purple-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Our experts are here to help you make informed decisions about your
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Your trusted partner in finding the perfect home and making
